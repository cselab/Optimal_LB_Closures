...
def get_args() -> argparse.Namespace:
    ...
    parser.add_argument("--environment", type=str, default="Kolmogorov21")
...
if __name__ == '__main__':
    ...
    train_env = KolmogorovEnvironment21(seeds=train_seeds, max_episode_steps=args.max_interactions, step_factor=args.step_factor)
    test_env = KolmogorovEnvironment21(seeds=val_seeds, max_episode_steps=args.max_interactions, step_factor=args.step_factor)
