...
from lib.environments.kolmogorov import KolmogorovEnvironment2
...
def get_args() -> argparse.Namespace:
    ...
    parser.add_argument("--step_per_collect", type=int, default=101) 
    parser.add_argument("--architecture", type=int, default=[32, 16])
...
if __name__ == '__main__':
    ...
    #save policy
    torch.save(policy.state_dict(), "dump/klmgrv_ppo.pth")
