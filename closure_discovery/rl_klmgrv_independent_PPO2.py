...
def get_args() -> argparse.Namespace:
    ...
    parser.add_argument("--environment", type=str, default="Kolmogorov18")
...
if __name__ == '__main__':
    ...
    train_env = KolmogorovEnvironment18(seeds=train_seeds, max_episode_steps=args.max_interactions, step_factor=args.step_factor)
    test_env = KolmogorovEnvironment18(seeds=val_seeds, max_episode_steps=args.max_interactions, step_factor=args.step_factor)
